...
/*!
 * \brief Страница управления складом.
 *
 * Отображает список продуктов с остатками и минимальными порогами.
 * Позволяет добавлять, убавлять или устанавливать точное количество.
 */
Page {
    title: "Склад"
