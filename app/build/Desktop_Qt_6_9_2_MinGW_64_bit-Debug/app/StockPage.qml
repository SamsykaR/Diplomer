...
Page {
    ...
    property int selectedProductIndex: -1   // единственное объявление
            ...
            delegate: ItemDelegate {
                ...
                RowLayout {
                    ...
                    Label {
                        text: model.name
                        font.pixelSize: 18
                        Layout.fillWidth: true          // занимает всё свободное пространство
                    }
                    Label {
                        text: model.quantity + " " + model.unit
                        font.pixelSize: 16
                        color: "#555"
                        Layout.alignment: Qt.AlignRight // прижимается к правому краю
                    }
                }
